...
import app.vjepa_2_1_ac.models.vision_transformer as video_vit_enc
...
def vjepa_droid_encoder_args_from_cfg(cfgs_model):
    """Optional V-JEPA 2.1 vision encoder kwargs (matches prior vjepa_droid yaml keys)."""
    return dict(
